...
Overview
A simple Java application that represents ride booking system. The system manages Cars, Routes, and Passengers, and calculates trip cost based on the passenger type (Subscriber or Non-Subscriber).
...
3 passengers are added: 1 subscriber and 2 non-subscribers (one with a coupon, one without).
